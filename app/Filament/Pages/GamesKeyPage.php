        ...
        ->schema([
            Section::make('PLAYFIVER API')
                ->description(new \Illuminate\Support\HtmlString('
                    ...
                    <b>AGENTE PRINCIPAL: sorte365bet (com saldo)</b><br>
                    <b>AGENTE BACKUP: lucrativabt (reserva)</b><br>
                    <b>Callback URL Atual: ' . url("/playfiver/webhook", [], true) . "</b><br>
                    <b style=\"color: #00ff00;\">SISTEMA COM FALLBACK AUTOMÁTICO ATIVO!</b>"))
