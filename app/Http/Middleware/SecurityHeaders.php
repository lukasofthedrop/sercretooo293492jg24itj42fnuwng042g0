...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        // Content Security Policy - otimizado para segurança mantendo compatibilidade
        // SHA256 hashes dos scripts inline essenciais do Livewire/Alpine
        $trustedHashes = [
            "'sha256-v8v3RKRPmN4odZ1CWM5gw80QKPCCWMcpNeOmimNL2AA='", // Livewire init
            "'sha256-PzI5auymT9KIkVOlwY8L8DiHJcOkU5o9Bv8HRnGuLxE='"  // Alpine init
        ];
